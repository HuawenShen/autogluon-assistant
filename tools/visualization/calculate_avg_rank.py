...
performance_data = [
    ...
    [0.43, -9999, 0.39, 0.40, 0.42, 0.39, 0.42, -9999, 0.25, -9999],  # airbnb
    [0.66, 0.66, 0.64, 0.64, 0.66, -9999, -9999, -9999, -9999, -9999],  # airlines
    ...
    [0.98, 0.97, -9999, 0.89, 0.98, -9999, 0.74, 0.95, -9999, -9999],  # covertype
    ...
    [0.56, -9999, -9999, 0.67, -9999, -9999, 0.78, -9999, -9999, -9999],  # ham10000
    [0.57, 0.53, -9999, 0.38, 0.57, 0.47, 0.52, -9999, 0.34, -9999],  # hateful
    [0.75, -9999, -9999, -9999, -9999, -9999, -9999, -9999, -9999, -9999],  # isic2017
    [0.44, 0.47, 0.43, 0.44, 0.44, -9999, 0.44, -9999, -9999, -9999],  # funding
    ...
    [0.39, 0.39, 0.40, 0.36, 0.39, -9999, 0.38, 0.39, 0.39, -9999],  # petfinder
    ...
    [0.75, 0.50, 0.61, 0.62, 0.75, -9999, 0.75, -9999, -9999, -9999],  # clothing
    [-8.53, -8.53, -8.92, -8.89, -8.53, -9999, -8.54, -9.60, -9999, -9.60]   # yolanda
]
