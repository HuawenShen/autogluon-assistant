...
def get_all_tutorials(tool_name: str, condensed: bool = False) -> List[Tuple[Path, str]]:
...
def save_selection_results(
    output_folder: Path,
    selected_tutorials: List[Tuple[Path, str]],
...
def generate_tutorial_prompt(
    ...
    Args:
        ...
        use_condensed: Whether to use condensed versions of tutorials
