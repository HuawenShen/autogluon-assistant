...
def generate_execution_prompt(output_folder, python_file_path, create_venv=True, 
                            previous_bash=None, previous_python=None, error_message=None, current_python=None):
    """
